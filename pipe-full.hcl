# ID=1500012898
# Name = Maosen Zhang
# modify : insert operations for "iaddl"
# I wrote "# modified by zms" where I modified
#fetch stage: instr_valid, need_regids, need_valC
#decode stage: d_srcB=D_rB, d_dstE=D_rB
...
bool instr_valid = f_icode in 
	{ INOP, IHALT, IRRMOVL, IIRMOVL, IRMMOVL, IMRMOVL,
	  IOPL, IJXX, ICALL, IRET, IPUSHL, IPOPL, IIADDL };                    # modified by zms
...
bool need_regids =
	f_icode in { IRRMOVL, IOPL, IPUSHL, IPOPL, 
		     IIRMOVL, IRMMOVL, IMRMOVL, IIADDL };                     # modified by zms

# Does fetched instruction require a constant word?
bool need_valC =
	f_icode in { IIRMOVL, IRMMOVL, IMRMOVL, IJXX, ICALL, IIADDL };    # modified by zms
...
int d_srcB = [
	D_icode in { IOPL, IRMMOVL, IMRMOVL, IIADDL  } : D_rB;         # modified by zms
...
int d_dstE = [
	D_icode in { IRRMOVL, IIRMOVL, IOPL, IIADDL } : D_rB;         # modified by zms
	D_icode in { IPUSHL, IPOPL, ICALL, IRET } : RESP;
...
int aluA = [
	...
	E_icode in { IIRMOVL, IRMMOVL, IMRMOVL, IIADDL } : E_valC;           # modified by zms
...
int aluB = [
	E_icode in { IRMMOVL, IMRMOVL, IOPL, ICALL, 
		     IPUSHL, IRET, IPOPL, IIADDL } : E_valB;                   # modified by zms
...
bool set_cc = E_icode in { IOPL, IIADDL } &&                                    # modified by zms
